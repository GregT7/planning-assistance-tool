...
Since I am not working with a team and want to adapt to the software production industry, I will be using an informal methodology I've coined as "Solo-scrum". Solo-scrum will be an approximation of Scrum while missing the core-team element of the methodology. However, in place of a team, I will be receiving feedback by completing a standup meeting with my parents every working day (6 days a week). I will still be completing daily standups, retrospectives, backlogs, and sprints. Furthermore, I will be maintaining proper documentation of the project including documents: minimum viable specifications, software development plan, project overview proposal, requirement specifications, and design specifications.
